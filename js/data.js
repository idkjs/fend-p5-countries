...
console.log('loading countryData');
...
// caribbean =[];
// countryData.forEach(function(subregion){
//     if(subregion.subregion === "Caribbean"){
//         caribbean.push(subregion.name.common);
//     }

// });
// console.log(JSON.stringify(caribbean, null, "\t"));
